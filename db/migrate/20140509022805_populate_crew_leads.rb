class PopulateCrewLeads < ActiveRecord::Migration[5.2]
  def up
    @crews = [
      ...
      { name: 'Carolinian Robbins', native_name: 'Каролинские красношейки', active: false },
      ...
      { name: 'GTO', native_name: 'ГТО', active: false },
      ...
      { name: 'Mandamus', native_name: 'Мандамус', active: false },
      { name: 'My People', native_name: 'Свои Люди' },
      { name: 'North People', native_name: 'Люди Севера', active: false },
      { name: 'Okhotnyj Ryad', native_name: 'Охотный ряд', active: false },
      { name: 'Palata #6', native_name: 'Палата №6' },
      { name: 'Pegassus', native_name: 'Пегас' },
      { name: 'Pshik & Co', native_name: 'Пшик и компания', active: false },
      { name: 'Sentyabryata', native_name: 'Сентябрята', active: false },
